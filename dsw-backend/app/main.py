...
async def apply_safe_migrations(conn):
    ...
    migration_statements = [
        ...
        # Event Reports & Submissions Workflow Columns & Indexes
        "ALTER TABLE event_reports ADD COLUMN IF NOT EXISTS department_id INTEGER;",
        "ALTER TABLE event_reports ADD COLUMN IF NOT EXISTS department_name VARCHAR(255);",
        "ALTER TABLE event_reports ADD COLUMN IF NOT EXISTS report_type VARCHAR(50) DEFAULT 'event_report';",
        "ALTER TABLE event_reports ADD COLUMN IF NOT EXISTS submitted_at TIMESTAMPTZ;",
        "ALTER TABLE event_reports ADD COLUMN IF NOT EXISTS reviewed_by INTEGER;",
        "ALTER TABLE event_reports ADD COLUMN IF NOT EXISTS reviewer_name VARCHAR(255);",
        "ALTER TABLE event_reports ADD COLUMN IF NOT EXISTS reviewed_at TIMESTAMPTZ;",
        "ALTER TABLE event_reports ADD COLUMN IF NOT EXISTS review_status VARCHAR(50) DEFAULT 'draft';",
        "ALTER TABLE event_reports ADD COLUMN IF NOT EXISTS review_remarks TEXT;",
        "ALTER TABLE event_reports ADD COLUMN IF NOT EXISTS points_awarded INTEGER DEFAULT 0;",
        ...
        "CREATE INDEX IF NOT EXISTS idx_event_reports_department_id ON event_reports (department_id);",
        "CREATE INDEX IF NOT EXISTS idx_event_reports_review_status ON event_reports (review_status);",
