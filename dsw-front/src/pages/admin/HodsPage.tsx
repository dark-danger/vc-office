...
export const HodsPage: React.FC = () => {
  ...
  const handleOpenHodModal = async (dept: DepartmentItem) => {
    ...
    try {
      ...
      // If department has an existing head, preselect
      ...
      {showHodModal && selectedDept && (() => {
        ...
        return (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-xs animate-fade-in overflow-y-auto">
            <div className="w-full max-w-lg glass-panel p-6 shadow-2xl relative my-auto animate-in zoom-in-95 max-h-[92vh] overflow-y-auto">
              <button
              ...
              {assignSuccess && (
                <div className="mb-4 p-3.5 rounded-xl bg-emerald-500/20 border border-emerald-500/40 text-emerald-300 text-xs font-bold flex items-center gap-2 shadow-sm animate-in fade-in">
                ...
                <div className="space-y-3.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="glass-input pl-10 pr-9 text-xs py-2.5 w-full bg-black/40 border-emerald-500/30 focus:border-emerald-500"
                      autoFocus
                    />
                    {facultySearchQuery && (
                      <button
                  ...
                  <div className="pt-3 border-t border-[var(--panel-border)] flex items-center justify-end gap-2.5">
                    ...
                    <button
                      ...
                      className="btn-primary text-xs py-2 px-5 font-bold shadow-md shadow-emerald-600/20 disabled:opacity-50 flex items-center gap-1.5 bg-gradient-to-r from-amber-600 to-amber-500 hover:from-amber-500 hover:to-amber-400"
                    >
